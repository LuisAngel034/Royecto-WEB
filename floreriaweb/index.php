<?php
//enrutador que indica cuando yo de click en una opcion
class Aplicacion {
    private $clase;
    private $metodo;
    ...
    public function __construct() {
        ...
        $this->clase = isset($_GET['clase']) ? filter_input(INPUT_GET, 'clase', FILTER_SANITIZE_STRING) : 'controladorlogin';
        $this->metodo = isset($_GET['metodo']) ? filter_input(INPUT_GET, 'metodo', FILTER_SANITIZE_STRING) : 'inicio';
    }
    ...
    private function cargarControlador($clase, $metodo) {
        ...
        if (file_exists($rutaArchivo)) {
            ...
            $objeto=new controladorprincipal();
            $objeto->inicio();
        }
    }
